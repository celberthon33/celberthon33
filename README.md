...
J’accompagne les organismes de formation, les CFA et les établissements d’enseignement avec des solutions concrètes, conçues pour leur fonctionnement réel.
...
### Depuis 2019
au cœur de la formation professionnelle

</td>
<td width="33%" align="center">

### 50+
sessions de certification organisées
...
Chaque mission commence par un cadrage précis du **besoin**, du **périmètre**, des **livrables** et des **délais**.

1. **Premier échange** pour comprendre le contexte, les contraintes et les échéances
2. **Cadrage et devis** pour définir une intervention claire
3. **Réalisation** à distance, sur site ou en format hybride
4. **Restitution** des livrables, des actions menées et des recommandations

> Une intervention structurée, transparente et adaptée au fonctionnement réel de votre établissement.

## Un profil métier, une culture technique

Je suis **Céline Berthon**, consultante indépendante et fondatrice de **CB Conseils & Synergie**.

Mon expérience en coordination pédagogique et en certification professionnelle s’appuie sur un parcours antérieur dans le développement web. Cette double culture me permet de traduire les besoins métier en processus lisibles et en outils simples, fiables et maintenables.

J’ai notamment conçu et développé le site vitrine de CB Conseils & Synergie avec :

`HTML5` · `CSS3` · `JavaScript` · `Vite` · `Handlebars`

Le projet intègre une architecture multipage, des composants réutilisables, une navigation responsive, des formulaires accessibles et une attention particulière portée à l’expérience utilisateur.

<div align="center">

<br>

## Et si nous mettions un peu d’ordre dans tout cela ?

Une échéance à sécuriser, une organisation à structurer ou un renfort ponctuel à trouver ? Présentez-moi votre contexte.
...
<sub>CB Conseils & Synergie · Certification professionnelle · Organisation pédagogique · Renfort administratif</sub>
